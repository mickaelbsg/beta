...
- **Philosophy:** System-driven Action Layer + Assistive LLM.
...
- **Execution:** Secure shell execution via `execFile` with command whitelist.
...
- **Prompt:** `src/agent-executor/prompt-builder.ts`.
